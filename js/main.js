...
//       // // ctx.setLineDash([4, 1]);
//       // this.ctx.arc(0, 0, this.r, Math.PI / 180 * -90, Math.PI / 180 * 270);
//       // this.ctx.ellipse(0, 0, this.r * Math.abs(Math.cos(Math.PI / 180 * angle)), this.r, 0, Math.sign(Math.cos(Math.PI / 180 * angle)) * Math.PI / 2, -Math.sign(Math.cos(Math.PI / 180 * angle)) * Math.PI / 2);
...
// })();
  ...
  //       this.ctx.beginParh;
  //       moveTo(-this.r * Math.cos(Math.PI / 180 * latitude),this.r * Math.sin(Math.PI / 180 * latitude) );
  //       this.ctx.lineTo(this.r * Math.cos(Math.PI / 180 * latitude),this.r * Math.sin(Math.PI / 180 * latitude) );
  ...
  //          this.ctx.fillText(90 , 200 * Math.cos(Math.PI / 180 * angle1) * 1.03, 200 * -Math.sin(Math.PI / 180 * angle1) * 1.03);
        
  //       let angle2 = 60;
  //       this.ctx.fillText(60 , 200 * Math.cos(Math.PI / 180 * angle2) * 1.05, 200 * -Math.sin(Math.PI / 180 * angle2) * 1.05);
        
  //       let angle3 = 30;
  //       this.ctx.fillText(30, 200 * Math.cos(Math.PI / 180 * angle3) * 1.05, 200 * -Math.sin(Math.PI / 180 * angle3) * 1.05);
        
  //       let angle4 = 0;
  //       this.ctx.fillText(0, 200 * Math.cos(Math.PI / 180 * angle4) * 1.05, 200 * -Math.sin(Math.PI / 180 * angle4) * 1.05);
        
  //       let angle5 = -30;
  //       this.ctx.fillText('-30', 200 * Math.cos(Math.PI / 180 * angle5) * 1.07, 200 * -Math.sin(Math.PI / 180 * angle5) * 1.07);
        
  //       let angle6 = -60;
  //       this.ctx.fillText('-60', 200 * Math.cos(Math.PI / 180 * angle6) * 1.08, 200 * -Math.sin(Math.PI / 180 * angle6) * 1.08);
        
  //       let angle7 = -90;
  //       this.ctx.fillText('-90', 200 * Math.cos(Math.PI / 180 * angle7) * 1.08, 200 * -Math.sin(Math.PI / 180 * angle7) * 1.08);
  ...
  //         ctx.moveTo(0, -200);
  //         ctx.lineWidth = 1;
  //         ctx.ellipse(0, 0, this.r * Math.abs(Math.cos(Math.PI / 180 * angle)), this.r, 0, Math.sign(Math.cos(Math.PI / 180 * angle)) * Math.PI / 2, -Math.sign(Math.cos(Math.PI / 180 * angle)) * Math.PI / 2);
  //         ctx.setLineDash([1, 5]);
  //         ctx.stroke();
  //       }
  //         ) } ;
